...
% Last Modified by GUIDE v2.5 07-May-2018 01:42:06
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global VIS IR mode t_concord IM_VIS IM_IR i max registered
% max=size(VIS,2);
max=2;
...
% for i=1:2
    ...
    registered{i} = imwarp(IM_IR{i},t_concord,'OutputView',Rfixed);
 
%     figure
%     c = strcat(IR{i},' + ',VIS{i});
%     title(c)
%     imshowpair(IM_VIS{i},registered{i},'blend')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global IM_VIS IM_IR t_concord i registered
set(handles.axes1,'Visible','off');
...
% obj = imshowpair(IM_VIS{i},registered,'blend')
figure
imshowpair(IM_VIS{i},registered{i},'blend')
% axes(handles.axes2);
% imshow(obj);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global IM_VIS IM_IR t_concord i max registered
set(handles.axes1,'Visible','off');
set(handles.text2,'String', 'Wykonywanie fuzji...');
if (i+1>=max)
    i = max;
